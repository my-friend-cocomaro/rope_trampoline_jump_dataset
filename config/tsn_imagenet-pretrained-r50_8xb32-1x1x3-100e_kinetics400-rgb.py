...
data_root = 'data/rope_trampoline_jump_dataset/train'
data_root_val = 'data/rope_trampoline_jump_dataset/val'
ann_file_train = 'data/rope_trampoline_jump_dataset/rope_trampoline_jump_dataset_train_video.txt'
ann_file_val = 'data/rope_trampoline_jump_dataset/rope_trampoline_jump_dataset_val_video.txt'
